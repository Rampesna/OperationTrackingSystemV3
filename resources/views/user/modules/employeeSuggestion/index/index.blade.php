...
@section('title', 'Personel Önerileri | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.dashboard.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-5 my-1">Personel Önerileri</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.employeeSuggestion.index.modals.showEmployeeSuggestion')
...
@section('customStyles')
    @include('user.modules.employeeSuggestion.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.employeeSuggestion.index.components.script')
@endsection
