            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-5">
                    ...
                    <div class="col-xl-4 mb-5">
                        <div onclick="createSoftware()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Ticari Yazılım Oluştur</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5 editingTransaction">
                        <div onclick="updateSoftware()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Ticari Yazılım Düzenle</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5 editingTransaction">
                        <div onclick="deleteSoftware()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Ticari Yazılım Sil</span>
                            </div>
                        </div>
                    </div>
