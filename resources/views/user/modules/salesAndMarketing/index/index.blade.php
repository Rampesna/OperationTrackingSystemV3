...
@section('content')
    ...
    <div class="row">
        ...
        @endif
        @if(checkUserPermission(220, $userPermissions))
            <a href="{{ route('user.web.salesAndMarketing.modules.category.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
                <div class="card h-lg-100">
                    <div class="card-body d-flex justify-content-between align-items-center flex-column">
                        <div class="m-0">
                            <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                        ...
                        <div class="d-flex flex-column mt-7">
                            <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Kategoriler</span>
                        </div>
                    </div>
                </div>
            </a>
        @endif
        @if(checkUserPermission(221, $userPermissions))
            <a href="{{ route('user.web.salesAndMarketing.modules.opponent.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
                <div class="card h-lg-100">
                    <div class="card-body d-flex justify-content-between align-items-center flex-column">
                        <div class="m-0">
                            <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                        ...
                        <div class="d-flex flex-column mt-7">
                            <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Rakip Firmalar</span>
                        </div>
                    </div>
                </div>
            </a>
        @endif
        @if(checkUserPermission(222, $userPermissions))
            <a href="{{ route('user.web.salesAndMarketing.modules.software.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
                <div class="card h-lg-100">
                    <div class="card-body d-flex justify-content-between align-items-center flex-column">
                        <div class="m-0">
                            <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                        ...
                        <div class="d-flex flex-column mt-7">
                            <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Ticari Yazılımlar</span>
                        </div>
                    </div>
                </div>
            </a>
        @endif
        @if(checkUserPermission(223, $userPermissions))
            <a href="{{ route('user.web.salesAndMarketing.modules.integrator.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
                <div class="card h-lg-100">
                    <div class="card-body d-flex justify-content-between align-items-center flex-column">
                        <div class="m-0">
                            <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                        ...
                        <div class="d-flex flex-column mt-7">
                            <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Entegratör Firmalar</span>
                        </div>
                    </div>
                </div>
            </a>
