...
@section('title', 'Raporlar / Personel Raporları | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.report.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Raporlar / Personel Raporları</h1>
        </div>
...
@section('content')
    ...
    <div class="row">
        ...
        @endif
        @if(checkUserPermission(204, $userPermissions))
        <a href="{{ route('user.web.report.employee.overtimeStartEnd.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                        <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Mesai Başlangıç-Bitiş Raporu</span>
                    </div>
                </div>
            </div>
        </a>
        @endif
        @if(checkUserPermission(205, $userPermissions))
        <a href="{{ route('user.web.report.employee.break.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                        <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Mola Raporu</span>
                    </div>
                </div>
            </div>
        </a>
        @endif
        @if(checkUserPermission(206, $userPermissions))
        <a href="{{ route('user.web.report.employee.monthlyAbsence.index') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                        <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Aylık Devamsızlık Raporu</span>
                    </div>
                </div>
            </div>
        </a>
