...
@section('title', 'Ayarlar / İş Departmanı Türleri | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.settings.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ayarlar / İş Departmanı Türleri</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.settings.jobDepartmentType.index.modals.createJobDepartmentType')
    @include('user.modules.settings.jobDepartmentType.index.modals.updateJobDepartmentType')
    @include('user.modules.settings.jobDepartmentType.index.modals.deleteJobDepartmentType')
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            <th class="">Firma</th>
                            <th class="">İş Departman Türü</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="jobDepartmentTypes"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.settings.jobDepartmentType.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.settings.jobDepartmentType.index.components.script')
@endsection
