...
@section('title', 'Ayarlar / Santral Kuyrukları | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.settings.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ayarlar / Santral Kuyrukları</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.settings.queue.index.modals.createQueue')
    @include('user.modules.settings.queue.index.modals.updateQueue')
    @include('user.modules.settings.queue.index.modals.deleteQueue')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 d-grid mb-5 text-end">
            <button class="btn btn-primary" onclick="createQueue()">Santral Kuyruğu Oluştur</button>
        </div>
    </div>
    <br>
    <div class="row">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            <th class="">Firma</th>
                            <th class="">Kuyruk Adı</th>
                            <th class="">Santral Kodu</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="queues"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.settings.queue.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.settings.queue.index.components.script')
@endsection
