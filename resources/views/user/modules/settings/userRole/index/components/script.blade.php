...
<script>
    ...
    function updateUserRole(id) {
        ...
        $.ajax({
            type: 'get',
            url: '{{ route('user.api.userRole.getById') }}',
            headers: {
    ...
    function updateUserRoleUserPermissions(roleId) {
        ...
        $.ajax({
            type: 'get',
            url: '{{ route('user.api.userRole.getUserPermissions') }}',
            headers: {
                'Accept': 'application/json',
                'Authorization': token
            },
            ...
            success: function (response) {
                ...
                jsTreeSelector.jstree({
                    ...
                    core: {
                        ...
                        check_callback: true,
                        data: setUserPermissionsTree(allUserPermissions, response.response)
                    }
                });
    ...
    function getUserPermissions() {
        $.ajax({
            type: 'get',
            url: '{{ route('user.api.userPermission.getByTopId') }}',
            headers: {
                'Accept': 'application/json',
                'Authorization': token
            },
            ...
            success: function (response) {
                allUserPermissions = response.response;
            },
            error: function (error) {
                console.log(error);
    ...
    function getUserRoles() {
        ...
        $.ajax({
            type: 'get',
            url: '{{ route('user.api.userRole.getAllUserRoles') }}',
            headers: {
                'Accept': 'application/json',
                'Authorization': token
            },
            ...
            success: function (response) {
                ...
                $.each(response.response.userRoles, function (i, userRole) {
                    userRoles.append(`
                    <tr>
                        <td>
                            ${userRole.name}
    ...
    function setUserRoleUserPermissions(userPermissions) {
        ...
        $.ajax({
            type: 'post',
            url: '{{ route('user.api.userRole.setUserPermissions') }}',
            headers: {
                'Accept': 'application/json',
                'Authorization': token
            },
    ...
    CreateUserRoleButton.click(function () {
        ...
        if (!name) {
            ...
            $.ajax({
                type: 'post',
                url: '{{ route('user.api.userRole.create') }}',
                headers: {
                    'Accept': 'application/json',
                    'Authorization': token
                },
    ...
    UpdateUserRoleButton.click(function () {
        ...
        if (!name) {
            ...
            $.ajax({
                type: 'put',
                url: '{{ route('user.api.userRole.update') }}',
                headers: {
                    'Accept': 'application/json',
                    'Authorization': token
                },
    ...
    DeleteUserRoleButton.click(function () {
        ...
        $.ajax({
            type: 'delete',
            url: '{{ route('user.api.userRole.delete') }}',
            headers: {
                'Accept': 'application/json',
                'Authorization': token
            },
