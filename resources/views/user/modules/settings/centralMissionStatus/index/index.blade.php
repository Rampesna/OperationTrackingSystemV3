...
@section('title', 'Ayarlar / Merkezi Görev Durumları | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.settings.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ayarlar / Merkezi Görev Durumları</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.settings.centralMissionStatus.index.modals.createCentralMissionStatus')
    @include('user.modules.settings.centralMissionStatus.index.modals.updateCentralMissionStatus')
    @include('user.modules.settings.centralMissionStatus.index.modals.deleteCentralMissionStatus')
...
@section('customStyles')
    @include('user.modules.settings.centralMissionStatus.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.settings.centralMissionStatus.index.components.script')
@endsection
