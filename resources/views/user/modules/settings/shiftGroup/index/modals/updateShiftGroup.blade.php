                                ...
                                <div class="row w-xl-1000px">
                                    <div class="col-xl-4 mb-5">
                                        <div class="form-group">
                                            <label for="update_shift_group_company_id" class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                <span class="required">Firma Seçimi</span>
                                            </label>
                                            <select id="update_shift_group_company_id" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Firma Seçimi"></select>
                                        </div>
                                    </div>
