...
@section('title', 'Ayarlar / Vardiya Grupları | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.settings.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ayarlar / Vardiya Grupları</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.settings.shiftGroup.index.modals.createShiftGroup')
    @include('user.modules.settings.shiftGroup.index.modals.updateShiftGroup')
    @include('user.modules.settings.shiftGroup.index.modals.deleteShiftGroup')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 d-grid mb-5 text-end">
            <button class="btn btn-primary" onclick="createShiftGroup()">Vardiya Grubu Oluştur</button>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody class="fw-bold text-gray-600" id="shiftGroups"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.settings.shiftGroup.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.settings.shiftGroup.index.components.script')
@endsection
