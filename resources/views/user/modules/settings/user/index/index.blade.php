...
@section('content')
    ...
    @include('user.modules.settings.user.index.modals.createUser')
    @include('user.modules.settings.user.index.modals.updateUser')
    @include('user.modules.settings.user.index.modals.deleteUser')
    @include('user.modules.settings.user.index.modals.setUserSuspend')
...
@section('customStyles')
    @include('user.modules.settings.user.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.settings.user.index.components.script')
@endsection
