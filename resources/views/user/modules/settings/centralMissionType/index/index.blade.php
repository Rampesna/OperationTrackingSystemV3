...
@section('title', 'Ayarlar / Merkezi Görev Türleri | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.settings.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ayarlar / Merkezi Görev Türleri</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.settings.centralMissionType.index.modals.createCentralMissionType')
    @include('user.modules.settings.centralMissionType.index.modals.updateCentralMissionType')
    @include('user.modules.settings.centralMissionType.index.modals.deleteCentralMissionType')
...
@section('customStyles')
    @include('user.modules.settings.centralMissionType.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.settings.centralMissionType.index.components.script')
@endsection
