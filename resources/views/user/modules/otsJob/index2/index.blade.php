...
@section('content')
    ...
    @include('user.modules.otsJob.index2.modals.setCallDataScanning')
    @include('user.modules.otsJob.index2.modals.setDataScanning')
    @include('user.modules.otsJob.index2.modals.setJobCaseWorkDelete')
    @include('user.modules.otsJob.index2.modals.setJobsClosedExcel')
    @include('user.modules.otsJob.index2.modals.setJobsExcel')
    @include('user.modules.otsJob.index2.modals.setJobsWithId')
    @include('user.modules.otsJob.index2.modals.setJobSuspend')
...
@section('customStyles')
    @include('user.modules.otsJob.index2.components.style')
@endsection

@section('customScripts')
    @include('user.modules.otsJob.index2.components.script')
@endsection
