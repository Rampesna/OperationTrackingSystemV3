<div class="modal fade show" id="SetJobSuspendModal" tabindex="-1" aria-modal="true" role="dialog" data-bs-backdrop="static">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Askıdaki İşleri Aktif Et</h1>
                    </div>
