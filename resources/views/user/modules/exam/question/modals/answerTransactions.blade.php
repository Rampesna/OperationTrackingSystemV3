<div class="modal fade show" id="AnswerTransactionsModal" aria-modal="true" role="dialog" data-bs-modal-backdrop-opacity="0.1">
        ...
        <div class="modal-content rounded" style="background: transparent; border: none; box-shadow: none">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-5">
                    ...
                    @if(checkUserPermission(63, $userPermissions))
                    <div class="col-xl-4 mb-5">
                        <div onclick="createAnswer()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Yeni Cevap Oluştur</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    @if(checkUserPermission(64, $userPermissions))
                    <div class="col-xl-4 mb-5 selectedAnswerTransaction">
                        <div onclick="updateAnswer()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Seçili Cevabı Düzenle</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    @if(checkUserPermission(65, $userPermissions))
                    <div class="col-xl-4 mb-5 selectedAnswerTransaction">
                        <div onclick="deleteAnswer()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Seçili Cevabı Sil</span>
                            </div>
                        </div>
                    </div>
                    @endif
