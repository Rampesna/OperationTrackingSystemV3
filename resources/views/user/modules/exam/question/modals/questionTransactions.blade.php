<div class="modal fade show" id="QuestionTransactionsModal" aria-modal="true" role="dialog" data-bs-modal-backdrop-opacity="0.1">
                    ...
                    <div class="col-xl-4 mb-5">
                        <div onclick="createQuestion()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Yeni Soru Oluştur</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-xl-4 mb-5 selectedQuestionTransaction">
                        <div onclick="updateQuestion()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Seçili Soruyu Düzenle</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-xl-4 mb-5 selectedQuestionTransaction">
                        <div onclick="deleteQuestion()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Seçili Soruyu Sil</span>
                            </div>
                        </div>
                    </div>
                    @endif
