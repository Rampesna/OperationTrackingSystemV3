...
@section('customStyles')
    @include('user.modules.exam.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.exam.index.components.script')
@endsection
