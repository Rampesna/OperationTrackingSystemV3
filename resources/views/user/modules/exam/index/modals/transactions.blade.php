            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-5">
                    ...
                    <div class="col-xl-12 mb-5">
                        <div onclick="createExam()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Sınav Oluştur</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5 selectedExamTransaction">
                        <div onclick="updateExam()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Sınavı Güncelle</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5 selectedExamTransaction">
                        <div onclick="examQuestions()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Sınav Soruları</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5 selectedExamTransaction">
                        <div onclick="deleteExam()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Sınavı Sil</span>
                            </div>
                        </div>
                    </div>
                    @if(checkUserPermission(198, $userPermissions))
                        <div class="col-xl-6 mb-5 selectedExamTransaction">
                            <div onclick="examEmployees()" class="card py-0 cursor-pointer">
                                <div class="card-body">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <span class="text-dark ms-5">Sınav Okuma</span>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if(checkUserPermission(199, $userPermissions))
                        <div class="col-xl-6 mb-5 selectedExamTransaction">
                            <div onclick="examResultList()" class="card py-0 cursor-pointer">
                                <div class="card-body">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <span class="text-dark ms-5">Sınav Sonuçlarını Göster</span>
                                </div>
                            </div>
                        </div>
                    @endif
