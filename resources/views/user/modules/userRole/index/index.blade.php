...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Rol Yönetimi</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.userRole.index.modals.createUserRole')
    @include('user.modules.userRole.index.modals.updateUserRole')
    @include('user.modules.userRole.index.modals.updateUserRoleUserPermissions')
    @include('user.modules.userRole.index.modals.deleteUserRole')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 d-grid mb-5 text-end">
            <button class="btn btn-primary" onclick="createUserRole()">Rol Oluştur</button>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody class="fw-bold text-gray-600" id="userRoles"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.userRole.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.userRole.index.components.script')
@endsection
