                    ...
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="update_employee_company_id" class="font-weight-bolder">Firma</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <select id="update_employee_company_id" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Firma">
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="update_employee_uyum_satis_api_crm_username" class="font-weight-bolder">Satış CRM Api Kullanıcı Adı</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="update_employee_uyum_satis_api_crm_username" type="text" class="form-control form-control-solid">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="update_employee_uyum_satis_api_crm_user_password" class="font-weight-bolder">Satış CRM Api Şifresi</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <input id="update_employee_uyum_satis_api_crm_user_password" type="text" class="form-control form-control-solid">
                                </div>
                            </div>
                        </div>
                        <hr class="text-muted">
