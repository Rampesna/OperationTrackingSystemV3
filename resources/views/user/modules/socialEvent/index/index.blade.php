...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Etkinlikler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.socialEvent.index.modals.createSocialEvent')
    @include('user.modules.socialEvent.index.modals.updateSocialEvent')
    @include('user.modules.socialEvent.index.modals.deleteSocialEvent')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 mb-5">
            <div class="form-group d-grid">
                <button class="btn btn-primary" onclick="createSocialEvent()">Yeni Etkinlik Oluştur</button>
            </div>
        </div>
    </div>
    <br>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            <th class="">#</th>
                            <th class="">Etkinlik Adı</th>
                            <th class="">Etkinlik Tarihi</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="socialEvents"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.socialEvent.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.socialEvent.index.components.script')
@endsection
