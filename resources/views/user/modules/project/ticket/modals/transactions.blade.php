            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-5">
                    ...
                    <div class="col-xl-4 mb-5">
                        <div onclick="updateTicket()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Düzenle</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5">
                        <div onclick="getTicketMessages()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                ...
                                <span class="text-dark ms-5">İncele</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5">
                        <div onclick="deleteTicket()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
