        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <textarea class="form-control form-control-lg form-control-solid" id="comment" name="comment" rows="3" placeholder="Yorumunuz..." aria-label="Yorumunuz"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-xl-12 text-end">
                        <button type="button" id="AddCommentSelectedTaskButton" class="btn btn-light-success font-weight-bold">Yanıtla</button>
                    </div>
                </div>
                <hr>
                <div class="row">
