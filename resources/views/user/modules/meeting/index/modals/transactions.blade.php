                    ...
                    <div class="col-xl-6 mb-5">
                        <div onclick="createMeeting()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Yeni Toplantı Planla</span>
                            </div>
                        </div>
                    </div>
                    @endif

                    @if(checkUserPermission(201, $userPermissions))
                    <div class="col-xl-6 mb-5">
                        <a href="{{ route('user.web.meeting.meetingAgenda') }}" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2hx">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Tüm Gündemler</span>
                            </div>
                        </a>
                    </div>
                    @endif
