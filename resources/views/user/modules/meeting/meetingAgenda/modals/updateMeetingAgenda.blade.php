                    ...
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="update_meeting_agenda_meeting_id" class="font-weight-bolder">Toplantı Seçimi</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <select id="update_meeting_agenda_meeting_id" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Toplantı Seçimi"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5">
