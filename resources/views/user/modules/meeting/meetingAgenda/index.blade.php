...
@section('title', 'Toplantı / Tüm Gündemler | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.meeting.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Toplantı / Tüm Gündemler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.meeting.meetingAgenda.modals.createMeetingAgenda')
    @include('user.modules.meeting.meetingAgenda.modals.updateMeetingAgenda')
    @include('user.modules.meeting.meetingAgenda.modals.deleteMeetingAgenda')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-5 mb-5">
                            <div class="form-group">
                                <label for="meetingId">Toplantı</label>
                                <select id="meetingId" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Toplantı"></select>
                            </div>
                        </div>
...
@section('customStyles')
    @include('user.modules.meeting.meetingAgenda.components.style')
@endsection

@section('customScripts')
    @include('user.modules.meeting.meetingAgenda.components.script')
@endsection
