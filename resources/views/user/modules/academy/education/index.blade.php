...
@section('title', 'Akademi / Akademi Eğitimleri | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.academy.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Akademi / Akademi Eğitimleri</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.academy.education.modals.createAcademyEducation')
    @include('user.modules.academy.education.modals.updateAcademyEducation')
    @include('user.modules.academy.education.modals.academyEducationLessons')
    @include('user.modules.academy.education.modals.deleteAcademyEducation')
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            <th style="width: 25%" class="">Firma</th>
                            <th class="">Ders Adı</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="academyEducations"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.academy.education.components.style')
@endsection

@section('customScripts')
    @include('user.modules.academy.education.components.script')
@endsection
