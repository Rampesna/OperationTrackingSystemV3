...
@section('title', 'Bilgi Bankası / Kategoriler | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.knowledgeBase.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Bilgi Bankası / Kategoriler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.knowledgeBase.category.modals.createKnowledgeBaseQuestionCategory')
    @include('user.modules.knowledgeBase.category.modals.updateKnowledgeBaseQuestionCategory')
    @include('user.modules.knowledgeBase.category.modals.deleteKnowledgeBaseQuestionCategory')
            ...
            <div class="card">
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody class="fw-bold text-gray-600" id="knowledgeBaseQuestionCategories"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.knowledgeBase.category.components.style')
@endsection

@section('customScripts')
    @include('user.modules.knowledgeBase.category.components.script')
@endsection
