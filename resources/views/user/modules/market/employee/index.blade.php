...
@section('title', 'Market Yönetimi / Personel Listesi | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Market Yönetimi / Personel Listesi</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.market.employee.modals.transactions')
    @include('user.modules.market.employee.modals.createMarketPayment')
...
@section('customStyles')
    @include('user.modules.market.employee.components.style')
@endsection

@section('customScripts')
    @include('user.modules.market.employee.components.script')
@endsection
