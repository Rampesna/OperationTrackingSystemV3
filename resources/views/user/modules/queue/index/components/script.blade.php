            ...
            success: function (response) {
                ...
                $.each(response.response.queues, function (i, queue) {
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <button onclick="updateQueue(${queue.id})" class="btn btn-sm btn-icon btn-primary" title="Düzenle">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button onclick="deleteQueue(${queue.id})" class="btn btn-sm btn-icon btn-danger ms-2" title="Sil">
