...
@section('title', 'Santral Kuyrukları | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.dashboard.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Santral Kuyrukları</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.queue.index.modals.createQueue')
    @include('user.modules.queue.index.modals.updateQueue')
    @include('user.modules.queue.index.modals.deleteQueue')
...
@section('customStyles')
    @include('user.modules.queue.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.queue.index.components.script')
@endsection
