...
@section('title', 'İş Departmanı Türleri | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href="{{ route('user.web.dashboard.index') }}" class="fas fa-lg fa-backward cursor-pointer me-5"></a>
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">İş Departmanı Türleri</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.jobDepartmentType.index.modals.createJobDepartmentType')
    @include('user.modules.jobDepartmentType.index.modals.updateJobDepartmentType')
    @include('user.modules.jobDepartmentType.index.modals.deleteJobDepartmentType')
...
@section('customStyles')
    @include('user.modules.jobDepartmentType.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.jobDepartmentType.index.components.script')
@endsection
