...
@section('title', 'İnsan Kaynakları / Personeller / Ödemeler | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">İnsan Kaynakları / Personeller / Ödemeler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.humanResources.employee.payment.modals.createPayment')
    @include('user.modules.humanResources.employee.payment.modals.updatePayment')
    @include('user.modules.humanResources.employee.payment.modals.deletePayment')
        ...
        <div class="col-xl-4 mb-5 text-end">
            <div class="row">
                <div class="col-xl-12 d-grid">
                    @if(checkUserPermission(127, $userPermissions))
...
@section('customStyles')
    @include('user.modules.humanResources.employee.payment.components.style')
@endsection

@section('customScripts')
    @include('user.modules.humanResources.employee.payment.components.script')
@endsection
