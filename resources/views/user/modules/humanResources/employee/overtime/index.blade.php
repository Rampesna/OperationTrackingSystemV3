...
@section('title', 'İnsan Kaynakları / Personeller / Mesailer | ')
...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">İnsan Kaynakları / Personeller / Mesailer</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.humanResources.employee.overtime.modals.createOvertime')
    @include('user.modules.humanResources.employee.overtime.modals.updateOvertime')
    @include('user.modules.humanResources.employee.overtime.modals.deleteOvertime')
...
@section('customStyles')
    @include('user.modules.humanResources.employee.overtime.components.style')
@endsection

@section('customScripts')
    @include('user.modules.humanResources.employee.overtime.components.script')
@endsection
