...
@section('title', 'İnsan Kaynakları / Personeller / Zimmetler | ')
...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">İnsan Kaynakları / Personeller / Zimmetler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.humanResources.employee.device.modals.createDevice')
    @include('user.modules.humanResources.employee.device.modals.updateDevice')
    @include('user.modules.humanResources.employee.device.modals.deleteDevice')
...
@section('customStyles')
    @include('user.modules.humanResources.employee.device.components.style')
@endsection

@section('customScripts')
    @include('user.modules.humanResources.employee.device.components.script')
@endsection
