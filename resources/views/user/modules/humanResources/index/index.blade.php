...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">İnsan Kaynakları</h1>
        </div>
            ...
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Kontrol Paneli</span>
                    </div>
                </div>
            </div>
        </a>
        <a href="{{ route('user.web.humanResources.calendar') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Takvim</span>
                    </div>
                </div>
            </div>
        </a>
        <a href="{{ route('user.web.humanResources.permit') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">İzinler</span>
                    </div>
                </div>
            </div>
        </a>
        <a href="{{ route('user.web.humanResources.overtime') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Mesailer</span>
                    </div>
                </div>
            </div>
        </a>
        <a href="{{ route('user.web.humanResources.payment') }}" class="col-xl-2 col-6 cursor-pointer mb-5">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Ödemeler</span>
                    </div>
                </div>
            </div>
        </a>
...
@section('customStyles')
    @include('user.modules.humanResources.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.humanResources.index.components.script')
@endsection
