...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Yetkinlikler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.competence.index.modals.createCompetence')
    @include('user.modules.competence.index.modals.updateCompetence')
    @include('user.modules.competence.index.modals.deleteCompetence')
...
@section('customStyles')
    @include('user.modules.competence.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.competence.index.components.script')
@endsection
