...
@section('title', 'Personel Özel Bilgileri | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-5 my-1">Personel Özel Bilgileri</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.specialInformation.index.modals.createSpecialInformation')
    @include('user.modules.specialInformation.index.modals.updateSpecialInformation')
    ...
    <div class="row">
        ...
        <div class="col-xl-6 text-end">
            <button class="btn btn-success" onclick="createSpecialInformation()">Yeni Kayıt Ekle</button>
        </div>
    </div>
{{--    <hr class="text-muted">--}}
...
{{--    </div>--}}
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="specialInformations"></div>
        </div>
    </div>
    <hr>
...
@section('customStyles')
    @include('user.modules.specialInformation.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.specialInformation.index.components.script')
@endsection
