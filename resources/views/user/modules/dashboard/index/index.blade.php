...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Performans Sistemi">
            <a href="{{ route('user.web.performance.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Performans Sistemi</span>
                    </div>
                </div>
            </a>
        </div>
...
{{--        </div>--}}
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Market Yönetimi">
            <a href="{{ route('user.web.market.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Market Yönetimi</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Satın Alımlar">
            <a href="{{ route('user.web.purchase.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Satın Alımlar</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Yemek Yönetimi">
            <a href="{{ route('user.web.foodList.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Yemek Yönetimi</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Merkezi Görev Sistemi">
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Personel Önerileri">
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Sınav Sistemi">
            <a href="{{ route('user.web.exam.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                    <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Sınav Sistemi</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Bilgi Bankası">
            <a href="{{ route('user.web.knowledgeBase.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                        <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Bilgi Bankası</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Bildirim Yönetimi">
            <a href="{{ route('user.web.notification.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                        <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Bildirim Yönetimi</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-2 col-6 mb-5 application" data-app-name="Sınav Sistemi">
            <a href="{{ route('user.web.settings.index') }}" class="card cursor-pointer h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-center flex-column">
                    <div class="m-0">
                    <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="d-flex flex-column mt-7">
                        <span class="fw-bold fs-5 text-gray-800 lh-1 ls-n2">Ayarlar</span>
                    </div>
                </div>
            </a>
        </div>
