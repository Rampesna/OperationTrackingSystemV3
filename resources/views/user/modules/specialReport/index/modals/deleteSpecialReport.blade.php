<div class="modal fade show" id="DeleteSpecialReportModal" tabindex="-1" aria-modal="true" role="dialog">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <div class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-danger" id="DeleteSpecialReportButton">Sil</button>
                    </div>
                </div>
            </div>
        </div>
