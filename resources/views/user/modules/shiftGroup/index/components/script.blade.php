            ...
            success: function (response) {
                ...
                $.each(response.response.shiftGroups, function (i, shiftGroup) {
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <button onclick="updateShiftGroup(${shiftGroup.id})" class="btn btn-sm btn-icon btn-primary" title="Düzenle">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button onclick="deleteShiftGroup(${shiftGroup.id})" class="btn btn-sm btn-icon btn-danger ms-2" title="Sil">
