...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Vardiya Grupları</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.shiftGroup.index.modals.createShiftGroup')
    @include('user.modules.shiftGroup.index.modals.updateShiftGroup')
    @include('user.modules.shiftGroup.index.modals.deleteShiftGroup')
...
@section('customStyles')
    @include('user.modules.shiftGroup.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.shiftGroup.index.components.script')
@endsection
