            ...
            <div class="modal-body">
                <div class="row ">
                    ...
                    <div class="col-xl-6 mb-5">
                        <div onclick="getPrCritterById()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Kriter Düzenle</span>
                            </div>
                        </div>
                    </div>

                    <div class="col-xl-6 mb-5 editingTransaction">
                        <div onclick="deletePrCritter()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Kriter Sil</span>
                            </div>
                        </div>
                    </div>
