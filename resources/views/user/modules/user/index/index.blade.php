...
@section('content')
    ...
    @include('user.modules.user.index.modals.createUser')
    @include('user.modules.user.index.modals.updateUser')
    @include('user.modules.user.index.modals.deleteUser')
    @include('user.modules.user.index.modals.setUserSuspend')
