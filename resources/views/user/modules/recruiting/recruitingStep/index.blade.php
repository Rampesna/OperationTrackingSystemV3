...
@section('title', 'İşe Alım Yönetimi / İşe Alım Aşamaları | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">İşe Alım Yönetimi / İşe Alım Aşamaları</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.recruiting.recruitingStep.modals.updateRecruitingStep')

    @include('user.modules.recruiting.recruitingStep.drawers.recruitingStepSubSteps')

    <button id="recruitingStepSubStepsDrawerButton" style="display: none"></button>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            <th class="w-50px">#</th>
                            <th class="">Aşama Adı</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="recruitingSteps"></tbody>
                    </table>
                </div>
            </div>
        </div>
...
@section('customStyles')
    @include('user.modules.recruiting.recruitingStep.components.style')
@endsection

@section('customScripts')
    @include('user.modules.recruiting.recruitingStep.components.script')
@endsection
