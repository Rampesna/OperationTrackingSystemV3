    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                @endif
                @if(checkUserPermission(224, $userPermissions))
                <a href="{{ route('user.web.performance.index') }}" class="menu-item {{ request()->segment(2) == 'performance' ? 'show' : '' }}">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Performans Sistemi</span>
                    </span>
                </a>
                @endif
                @if(checkUserPermission(181, $userPermissions))
                <a href="{{ route('user.web.qualityAssessment.index') }}" class="menu-item {{ request()->segment(2) == 'qualityAssessment' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Kalite Değerlendirme</span>
                    </span>
                </a>
                @endif
{{--                <a href="{{ route('user.web.closingJob.index') }}" class="menu-item {{ request()->segment(2) == 'closingJob' ? 'show' : '' }}">--}}
{{--                    <span class="menu-link">--}}
{{--                        <span class="menu-icon">--}}
{{--                            <span class="svg-icon svg-icon-1">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">--}}
...
{{--                </a>--}}
                ...
                <a href="{{ route('user.web.career.index') }}" class="menu-item {{ request()->segment(2) == 'career' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Kariyer Başvuruları</span>
                    </span>
                </a>
                @endif
                @if(checkUserPermission(190, $userPermissions))
                <a href="{{ route('user.web.batchSms.index') }}" class="menu-item {{ request()->segment(2) == 'batchSms' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">SMS Servisi</span>
                    </span>
                </a>
                @endif
                ...
                <a href="{{ route('user.web.employeeSuggestion.index') }}" class="menu-item {{ request()->segment(2) == 'employeeSuggestion' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Personel Önerileri</span>
                    </span>
                </a>
                @endif
                @if(checkUserPermission(197, $userPermissions))
                <a href="{{ route('user.web.exam.index') }}" class="menu-item {{ request()->segment(2) == 'exam' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Sınav Sistemi</span>
                    </span>
                </a>
                @endif
                @if(checkUserPermission(207, $userPermissions))
                <a href="{{ route('user.web.knowledgeBase.index') }}" class="menu-item {{ request()->segment(2) == 'knowledgeBase' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                @endif
                @if(checkUserPermission(216, $userPermissions))
                <a href="{{ route('user.web.notification.index') }}" class="menu-item {{ request()->segment(2) == 'notification' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <a href="{{ route('user.web.settings.index') }}" class="menu-item {{ request()->segment(2) == 'settings' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                @endif
                @if(checkUserPermission(3, $userPermissions))
                    <a href="{{ route('user.web.jobFileList.index') }}" class="menu-item {{ request()->segment(2) == 'jobFileList' ? 'show' : '' }}">
                   <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Dosya Yükleme İşlemleri</span>
                    </span>
                    </a>
                @endif
                <a href="{{ route('user.web.earthquakeInformation.index') }}" class="menu-item {{ request()->segment(2) == 'earthquakeInformation' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">Deprem Bilgileri</span>
                    </span>
                </a>
                <a href="{{ route('user.web.specialInformation.index') }}" class="menu-item {{ request()->segment(2) == 'specialInformation' ? 'show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
{{--                            </span>--}}
{{--                        </span>--}}
{{--                        <span class="menu-title">Ekran Takibi</span>--}}
{{--                    </span>--}}
{{--                </a>--}}
